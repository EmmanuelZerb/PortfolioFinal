  ...
  return (
    <section className="relative min-h-screen flex items-center px-6 md:px-12 lg:px-24">
      ...
      >
        ...
        <motion.h1
          variants={item}
          className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 leading-none tracking-tight"
        >
          Emmanuel
          <br />
          <span className="gradient-text">Zerbib</span>
        </motion.h1>
        ...
        <motion.div variants={item} className="flex flex-wrap gap-4">
          ...
          <a
            href="/cv"
            className="px-8 py-4 border border-zinc-700 rounded-full hover:border-zinc-500 transition-all duration-300 inline-flex items-center gap-2"
          >
            <svg
              className="w-4 h-4"
              fill="none"
        ...
        <motion.div variants={item} className="mt-16 flex gap-6">
          <a
          ...
          <a
            href="https://www.linkedin.com/in/emmanuel-zerbib/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-zinc-500 hover:text-zinc-300 transition-colors"
            aria-label="LinkedIn"
